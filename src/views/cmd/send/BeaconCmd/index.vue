    ...
    <el-header style="padding-left: 0px">
      ...
      <div class="topTitleBox">
        ...
        <div style="position: absolute; top: 35px; left: 60px">
          <div>
            <el-form ref="id" label-width="60px">
              <el-form-item label="设备ID" id="lable" v-hasPermi="['cmd:send']">
                <el-select
        ...
        <el-row :gutter="22">
          <el-col :span="14" style="padding-right: 5px">
            <el-row>
              <!--导航配置-->
              <el-col :span="24">
                <navigation-config-beacon :deviceId="selectDeviceId" :deviceCdId="selectDeviceCdId" />
              </el-col>
            </el-row>
...
import navigationConfigBeacon from "./modules/navigationConfigBeacon";
...
export default {
  ...
  methods: {
    ...
    customCmd() {
      ...
      // this.$refs.cmdAddModal.title = '自定义指令';
    },
