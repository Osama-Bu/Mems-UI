<template>
  <el-card class="box-card">
    <div slot="header" class="clearfix">
      <span style="color: #06f1ef">导航配置</span>
      <el-button
        style="float: right"
        @click="pushMethod"
        type="primary"
...
<script>
import cmdGlide from "./cmdGlide";
import pathTrack from "../../modules/./pathTrack";
import courseSet from "../../modules/./courseSet";
export default {
  name: "navigationConfigGlider",
  props: {
    deviceId: undefined,
    deviceCdId: undefined,
  },
  components: { cmdGlide, pathTrack, courseSet },
  data() {
    return {
      // 暂未使用
