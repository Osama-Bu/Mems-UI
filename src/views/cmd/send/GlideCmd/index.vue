        ...
        <el-row :gutter="22">
          <el-col :span="14" style="padding-right: 5px">
            <el-row>
              <!--导航配置-->
              <el-col :span="24">
                <navigation-config-glide :deviceId="selectDeviceId" :deviceCdId="selectDeviceCdId" />
              </el-col>
            </el-row>
...
import navigationConfigGlide from "./modules/navigationConfigGlide";
