<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item :label="$t('systemManage.organization.search.orgName')" prop="deptName">
        <el-input
      ...
      <el-form-item :label="$t('systemManage.organization.search.orgStatus')" prop="status">
        <el-select v-model="queryParams.status" :placeholder="$t('systemManage.organization.search.orgStatus')" clearable>
          <el-option
    ...
    >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width"
                       v-if="$store.getters.permissions.indexOf('system:dept:edit') !==-1
                       || $store.getters.permissions.indexOf('system:dept:add') !==-1
