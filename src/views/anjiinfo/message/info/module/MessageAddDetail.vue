  ...
  <div class="app-container">
    ...
    >
      <el-steps
        ...
        space="300px"
      >
        <el-step :title="$t('messageInfo.addAndEdit.addStep1')" :description="$t('messageInfo.addAndEdit.status3')"></el-step>
        <el-step :title="$t('messageInfo.addAndEdit.addStep2')" :description="$t('messageInfo.addAndEdit.status1')"></el-step>
      </el-steps>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item :label="$t('messageInfo.addAndEdit.item.model')">
          ...
          <el-checkbox
            ...
            >{{ $t('messageInfo.addAndEdit.item.repeat') }}</el-checkbox
          >
          ...
          <div style="float: right">
            ...
            <el-button
              ...
              icon="el-icon-edit"
              @click="addRow(-1)"
              >{{ $t('messageInfo.addAndEdit.item.add') }}</el-button
            >
          </div>
        </el-form-item>
      </el-form>
            ...
            <template slot-scope="scope">
              <div>
                <el-button
                  ...
                  >{{ $t('messageInfo.addAndEdit.item.operate.add') }}</el-button
                >
              </div>
              <div>
                <el-button
                  ...
                  >{{ $t('messageInfo.addAndEdit.item.operate.delete') }}</el-button
                >
              </div>
            </template>
          </el-table-column>
...
import { addMessageInfo, getMessageInfo, getMessageDataType, getMsgItemsByMsgId } from "@/api/message/message";
import Sortable from "sortablejs";
import * as XLSX from 'xlsx';

export default {
  name: "MessageAddDetail",
  components: {
    Treeselect,
  },
  data() {
  ...
  methods: {
    ...
    submitForm: function () {
      ...
      addMessageInfo(this.messageInfo).then((response) => {
    ...
    rowDrop() {
      const tbody = document.querySelector(
        ".message-add .el-table__body-wrapper tbody"
      );
      const _this = this;
